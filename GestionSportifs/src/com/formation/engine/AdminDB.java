...
public class AdminDB {
	...
	public void editer(Admin a, int id) throws SQLException {
		...
		Log.write("L'administrateur "+a.getNom()+" "+a.getPrenom()+" a été édité");
	}
	public void close() {
		db.close();
	}
